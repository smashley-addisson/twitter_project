...
badDomains = open('/home/freemandyson/Projects/python/twitter_project/experiments/domains.txt', 'r') ###### change path for input file
results = open('/home/freemandyson/Projects/python/twitter_project/experiments/results.txt', 'w') ###### change path for input file
